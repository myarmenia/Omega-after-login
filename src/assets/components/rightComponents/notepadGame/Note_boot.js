...
class NoteBoot extends Component {
    constructor(props){
        super(props);
        this.state = {
            time_out: true,
...
*/
    ...
    answer=(e)=>{
     ...
     this.setState({ time:20});
           //  console.log(getAnswer,"getAnswergetAnswer");
          //console.log(this.state.answerVariants ,"vvvvvvvvvvvvv");
          //  console.log(this.state.answerVariants[i].true_id ,"this.state.answerVariants[f].true_id ");
     if (this.state.answerVariants[i].true_id === getAnswer)
      ...
      if(enter > 0){
             for(let ind = 0; ind < enter; ++ind){
               ...
               //  console.log(this.state.code,"aftererrerererre");
             }
         }
         if(tab > 0){
             for(let ind = 0; ind < tab; ++ind){
                 if(enter > 0){
                  //   console.log(ind,"indindind");
                     this.setState({code:`${this.state.code}\t`});
                   //  console.log(this.state.code,"aTTTTTTTTTttte");
                 }
             }
         }
       //  console.log(tab,"tab");
       //  console.log(enter,"enter");
       //  console.log(this.state.code,"this.state.codethis.state.codethis.state.code")
          let answerVariant;
    ...
    //console.log(sis,"sis");
         switch( sis.type ) {
             ...
             case '26':
                     if(k4 === 0){
                         ...
                         this.setState({
                            // yntacikk: answerVariant,
                             fornextValue:sis.text
                         });
                         k3=1;
                         k4=1;
                     }
                     else if (k4 === 1){
                         value+=' '+this.state.fornextValue;
                         answerVariant = this.state.yntacikk + '<'+this.state.forAttributeTag+' '+this.state.forAttribute+'="'+value+' '+sis.text+'"';
                         this.setState({
                            fornextValue:sis.text
                         });
                         k3=0;
       ...
       //  console.log(answerVariant,"answerVariantanswerVariantanswerVariantanswerVariant")
         setTimeout(() => {
             if (!this.state.attr){
                 this.setState({code: `${this.state.code} ${answerVariant}`,
                    });
            //    console.log("ffalseeeeeee")
             }
             else{
                 this.setState({code: `${answerVariant}`,
                     });
      ...
      /*   e.style.transition = '1s';
         ...
         if (e.id === '1') {
             e.style.transform = 'translate(50px,-250px) rotate(360deg)';
             e.style.opacity = '0';
             e.style.width = '50px';
         }
         if (e.id === '2') {
         ...
         if (e.id === '2') {
             e.style.transform = 'translate(-410px,-250px) rotate(360deg)';
             e.style.opacity = '0';
             e.style.width = '50px';
         }
         if (e.id === '4') {
             e.style.transform = 'translate(-820px,-250px) rotate(360deg)';
             e.style.opacity = '0';
             e.style.width = '50px';
         }*/
         this.setState({
...
render(){
    //console.log(this.props.diamonds,"this.props.diamondsthis.props.diamonds");
    //console.log(this.props.count_mark, "this.state.count_markthis.state.count_mark")
    //  console.log(this.props.self_mark, "this.state.self_markthis.state.self_markthis.state.self_mark")
    //console.log(this.props.gameID ,'this.props.gameID ')
    //console.log(this.props.course_Data ,'course_Data ');
    // console.log(this.props.course_Name ,'course_Name ');
        ...
        if (i < this.state.answerVariants.length){
            ...
            return (
                ...
                <a href="#answer" id ="1"   className="btn btn-sm animated-button sandy-three buttons" onClick={this.answer}>
                    1. &nbsp;
                ...
                <a href="#answer" id ="2"   className="btn btn-sm animated-button sandy-three buttons" onClick={this.answer}>
                    2. &nbsp;
        { item.a2.type ==='1'?'<'+item.a2.text+'>':item.a2.type ==='2'?'<'+item.a2.text:
            item.a2.type ==='3'?item.a2.text:item.a2.type ==='4'?item.a2.text:item.a2.type ==='5'?item.a2.text:item.a2.type ==='6'?
                '</'+item.a2.text+'>':item.a2.type ==='7'?item.a2.text:item.a2.type ==='8'?'<'+item.a2.text+'/>':item.a2.type ==='9'? item.a2.text:item.a2.text}
                    ...
                    <a href="#answer" id ="3" className="btn btn-sm animated-button sandy-three buttons" onClick={this.answer}>
                        3. &nbsp;
                    ...
                    <a href="#answer" id ="4"   className="btn btn-sm animated-button sandy-three buttons" onClick={this.answer}>
                    4. &nbsp;
        ...
        return( <div className="container">
            {this.state.loaded ?
                ...
                <span id="points" style={{height:'110px'}}>
                    ...
                    <span>
                     {this.props.lang==='eng'?'Score':'Միավորներ'}  <img src={require('../../../images/coin.png')} className="scoreImg"   alt="coin"  style={{width: '35px',
                        marginTop: '-7px'}}/>   : {this.state.points}
                        </span>
                    }
                </span>
                ...
                <div className={`alertContainer ${this.state.isRight ? 'green' : 'red'}`} style={{
                    ...
                    <h1 className="alertText"><div className="checkmark" ></div></h1>{/*<h1 className="alertText">{this.state.alertText}</h1>*/}
                </div>
                ...
                <div className="questionContianer">
                    ...
                    <div className="rightBar"  style={{backgroundImage:`${rightImg_url}`}} >{/*<img  src={browserImg} alt=""/>*/}</div>
                    </div>
                </div>
                }
                {this.state.showAnswers &&
